...
Use these prompts in Copilot Chat for common tasks:
- `/create-view` - Generate a new SwiftUI view with proper structure
- `/add-analytics` - Add analytics tracking to a feature
- `/accessibility-audit` - Review a view for accessibility issues
- `/create-endpoint` - Add a new API endpoint
